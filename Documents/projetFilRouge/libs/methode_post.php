    ...
    if (isset($_POST['formulaire'])) {
        if ($_POST['formulaire'] == 'register') {
            ...
            Apropos
                    ...
                    MailEngine::send('Le membre '.$_POST["Prenom"].' '.$_POST["Nom"].' vient de s\'inscrire sur MCMP', $_POST["Email"], $_POST['Login'], 'Vous avez un nouvel inscrit sur votre site MCMP, direction http://cda27.s1.2isa.org/page-membres pour activer le nouveau membre et n\'oubliez pas de répondre à cet email quand ce membre sera activé!');
