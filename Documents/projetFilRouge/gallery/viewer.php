...
if (
    ...
    if ((isset($_GET['filename'])) && (preg_match("/^[^\/\"'<>*]+$/", $_GET['filename']))) {  
        ...
        if($previous_file !== false) {$html_content .= '<div id="previous" class="p"><a href="index.php?page=viewer&category='.$requested_category.'&filename='.$previous_file.'">&lt;</a></div>';}
        if($next_file !== false) {$html_content .= '<div id="next"><a href="index.php?page=viewer&category='.$requested_category.'&filename='.$next_file.'">&gt;</a></div>';}
