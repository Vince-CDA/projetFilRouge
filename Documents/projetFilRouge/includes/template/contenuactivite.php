<main>
    ...
    ?>
            ...
            <div class="col-12 mt-4 mb-4">
              <div class="row  zform p-3 p-md-6 background-11 radius-secondary border color-3 mb-3 ">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group"><label class="ls text-uppercase color-3 fw-700 mb-0">Type d'activité</label> :  <?php echo $type; ?></div>
                </div>
                <div class="col-md-4">
        ...
        ?>
                ...
                <?php
    } elseif (isset($_SESSION['User_Level']) && $_SESSION['User_Level'] > 0 && isset($inscrit) && !empty($inscrit)) {
        ?>
                <div class="row justify-content-center col-md-12 mt-2 mb-3">
                ...
                <div class="row justify-content-center text-center col-md-12 mt-2 mb-3">
                <?php echo $total; ?>
                </div>
                </div>
            </div>
