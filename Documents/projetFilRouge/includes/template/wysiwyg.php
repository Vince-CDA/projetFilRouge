...
<div class="row h-full  justify-content-center py-5">
                    <div class="col-8">
                                    <div class="mb-2">
                                        ...
                                        <input class="texte-right" type="checkbox" name="diffusion" value="1" <?php echo isset($diffusion) && !empty($diffusion) && $diffusion == 1 ? 'checked' : ''; ?>/> News pour tous ?
                                        <input class="texte-right" type="checkbox" name="diffusion2" value="1" <?php echo isset($diffusion) && !empty($diffusion) && $diffusion > 1 ? 'checked' : ''; ?>/> News pour les membres ?
                                    </div>  
