            ...
            <div class="card h-100 col-sm-12 col-lg-10 col-md-10 col-xl-4 margincustom"><a class="overflow-hidden" href="page-newscontent-<?php echo $idactivite; ?> "><img class="card-img-top mt-3" src="<?php echo $fichieractivite; ?>" alt="Card image cap"></a>
