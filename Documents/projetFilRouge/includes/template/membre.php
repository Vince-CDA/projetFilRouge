...
<div class="col-sm-6 col-lg-4 mb-lg-0 mb-4">
    <div class="border border-2x radius-secondary border-color-10 py-4"><img class="radius-round" src="./images/portraits/square/04.jpg" alt="Member" width="120">
        ...
        <h6 class="color-7 mb-4"><?php echo $Donnees['CC']; ?></h6><?php if (isset($_SESSION['User_Level']) && $_SESSION['User_Level'] > 1) { ?><a class="btn-icon-pop fs--1 fw-600" href="page-membres-delete-<?php echo $Donnees['IdAdherent']; ?>"><span class="fa fa-remove mr-2" data-fa-transform="grow-10"></span>Supprimer ce membre</a><?php } ?>
    </div>
</div>