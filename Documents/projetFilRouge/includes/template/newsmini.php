...
<div class="<?php echo isset($bonus) ? 'card-ombre' : ''; ?> card h-100 col-sm-12 col-lg-10 col-md-10 col-xl-5 margincustom"><a class="overflow-hidden" href="page-newscontent-<?php echo $idnews; ?> "><img class="card-img-top mt-3" src="<?php echo $fichiernews; ?>" alt="Card image cap"></a>
